...
class _MapScreenState extends State<MapScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    // Compute map center: user location > first valid issue > default
    final center = _userLocation ??
        (validIssues.isNotEmpty
            ? LatLng(validIssues.first.location.latitude,
                validIssues.first.location.longitude)
            : _defaultCenter);
